...
from trade.extract import extract_outputs, extract_preview_outputs, write_outputs
from trade.paths import build_paths
...
def _dynamic_task_config(profile: PaperTradingProfile, provider_uri: Path, effective_end: pd.Timestamp) -> dict:
    ...
    from research.settings import BENCHMARK, load_full_universe
