...
from qlib_tw.trade.extract import extract_outputs, extract_preview_outputs, write_outputs
from qlib_tw.trade.paths import build_paths


LOGGER = logging.getLogger("qlib_tw.trade.replay")
...
def _dynamic_task_config(profile: PaperTradingProfile, provider_uri: Path, effective_end: pd.Timestamp) -> dict:
    ...
    from qlib_tw.research.settings import BENCHMARK, load_full_universe
