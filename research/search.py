...
from research.builders import apply_strategy_overrides, build_port_analysis_config, build_task_config
from research.ic import calc_daily_ic
from research.paths import set_output_dirs
from research.publish import promote_output
from research.reports import dump_report_frames
from research.settings import COMBO_CONFIGS, PROVIDER_URI, REGION, UNIVERSE


LOGGER = logging.getLogger("auto_search_pipeline")

DEFAULT_OUTPUT_ROOT = Path(__file__).resolve().parent.parent / "outputs" / "auto_pipeline"
